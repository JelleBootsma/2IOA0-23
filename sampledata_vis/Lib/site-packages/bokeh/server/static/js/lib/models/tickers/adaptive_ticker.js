...
var AdaptiveTicker = /** @class */ (function (_super) {
    ...
    AdaptiveTicker.prototype.initialize = function () {
        ...
        var prefix_mantissa = array_1.nth(this.mantissas, -1) / this.home;
        var suffix_mantissa = array_1.nth(this.mantissas, 0) * this.home;
    ...
    AdaptiveTicker.prototype.get_interval = function (data_low, data_high, desired_n_ticks) {
        ...
        var interval_exponent = Math.floor(log(ideal_interval / this.base_factor, this.home));
        var ideal_magnitude = Math.pow(this.home, interval_exponent) * this.base_factor;
